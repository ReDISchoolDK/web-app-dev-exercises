...
function HomePage() {
	return (
		<div className="mx-auto max-w-2xl p-8">
			...
			<h1 className="mb-2 text-3xl font-bold">Zustand + Immer — Bookmarks</h1>
			...
			<p className="mb-6 rounded-md border border-dashed px-4 py-3 text-sm text-muted-foreground">
				...
				<code className="rounded bg-muted px-1">exercise-bookmarks</code> first.
			</p>
			...
			<div className="rounded-md border border-dashed px-4 py-3">
				<p className="text-sm text-muted-foreground">
					Start here:{" "}
					<Link to="/exercise/bookmarks" className="underline">
						/exercise/bookmarks
					</Link>
				</p>
			</div>
