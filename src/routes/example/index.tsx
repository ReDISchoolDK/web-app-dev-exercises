// =====================================================================
// EXAMPLE PAGE — a worked example you can read, run and copy from.
//
...
//
// Nothing else imports this page, so when you no longer need it you can
// delete this folder and the "Example" link in src/components/Header.tsx.
// =====================================================================
	...
	return (
		<div className="mx-auto max-w-2xl p-8">
			<p className="mb-6 rounded-md border border-dashed px-4 py-3 text-sm text-muted-foreground">
				This is the example page. The code behind it is in{" "}
